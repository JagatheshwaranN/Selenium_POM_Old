...
/**
 * A class is created with name : SignIn SignIn class extends Common_Functions
 * class to utilize the reusable methods of the Common_Functions class
 * 
 * @author Jagatheshwaran
 */
public class SignIn extends Common_Functions {
	...
	/**
	 * Initializing Logger Common_Functions class Object is initialized
	 */
